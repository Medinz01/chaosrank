...
class TestFetchFormalIncidentsPagination:
    def test_offset_pagination(self, adapter):
        ...
        mock_r1 = MagicMock(); mock_r1.json.return_value = page1; mock_r1.raise_for_status = MagicMock()
        mock_r2 = MagicMock(); mock_r2.json.return_value = page2; mock_r2.raise_for_status = MagicMock()
